          ...
          <Row>
            ...
            <Col md={6}>
              <Form.Group controlId="cv">
                ...
                <FileUploader onChange={handleCVUpload} onUpload={handleCVUpload} className="shadow-sm" />
              </Form.Group>
              <Row className="mt-4">
                <Button onClick={() => handleAddSection("educations")} className="btn btn-primary btn-sm mr-2">
                  Añadir Educación
                </Button>
              </Row>
              ...
              <Row className="mt-4">
                <Button onClick={() => handleAddSection("workExperiences")} className="btn btn-primary btn-sm mr-2">
